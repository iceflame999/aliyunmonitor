...
class rooboaliyun:
    ...
    def get_disk(self,instanceID,date):

        request = QueryMetricListRequest.QueryMetricListRequest()
        request.set_accept_format('JSON')
        request.set_Project('acs_rds_dashboard')
        request.set_Metric('DiskUsage')
        request.set_StartTime(str(date) + ' 00:00:00')
        request.set_EndTime(str(date) + ' 23:59:00')
        request.set_Dimensions("{'instanceId':'" + instanceID + "'}")
        request.set_Period('60')
    ...
    def get_iops(self,instanceID,date):

        request = QueryMetricListRequest.QueryMetricListRequest()
        request.set_accept_format('JSON')
        request.set_Project('acs_rds_dashboard')
        request.set_Metric('IOPSUsage')
        request.set_StartTime(str(date) + ' 00:00:00')
        request.set_EndTime(str(date) + ' 23:59:00')
        request.set_Dimensions("{'instanceId':'" + instanceID + "'}")
        request.set_Period('60')
    ...
    def get_conn(self,instanceID,date):

        request = QueryMetricListRequest.QueryMetricListRequest()
        request.set_accept_format('JSON')
        request.set_Project('acs_rds_dashboard')
        request.set_Metric('ConnectionUsage')
        request.set_StartTime(str(date) + ' 00:00:00')
        request.set_EndTime(str(date) + ' 23:59:00')
        request.set_Dimensions("{'instanceId':'" + instanceID + "'}")
        request.set_Period('60')
