...
for host in hostid :
    ...
    #insert_avg(host,today_1,a[0],a[1],a[2],a[3])    #插入记录表
    #a = getavg(today_2,host)   #获取设备数据
    #insert_avg(host,today_2,a[0],a[1],a[2],a[3])    #插入记录表
    #a = getavg(today_3,host)   #获取设备数据
    #insert_avg(host,today_3,a[0],a[1],a[2],a[3])    #插入记录表
    #a = getavg(today_4,host)   #获取设备数据
    #insert_avg(host,today_4,a[0],a[1],a[2],a[3])    #插入记录表
    a = getavg(today_5,host)   #获取设备数据
    insert_avg(host,today_5,a[0],a[1],a[2],a[3])    #插入记录表
    a = getavg(today_6,host)   #获取设备数据
    insert_avg(host,today_6,a[0],a[1],a[2],a[3])    #插入记录表
    a = getavg(today_7,host)   #获取设备数据
    insert_avg(host,today_7,a[0],a[1],a[2],a[3])    #插入记录表
